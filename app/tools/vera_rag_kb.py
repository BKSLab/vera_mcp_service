...
VERA_RAG_KB_DESCRIPTION = (
    ...
    "query — самодостаточный текст юридического вопроса с существенным контекстом "
    "из текущего сообщения и истории диалога. Поиск выполняется по всей доступной "
    "базе знаний без ограничения по роли пользователя. "
